...
private const val MAIN_NET_URL = "https://horizon.kik-kin-federation.com/"
...
class Wallet(context: Context, dataStoreProvider: DataStoreProvider,
    ...
    fun payForOrder(toAddress: String, amount: Int, orderId: String): TransactionId {
        //TODO: Send the transaction to the Kinit server
        throw Exception()
//        return account.buildTransactionSync(toAddress, BigDecimal(amount), 0)
